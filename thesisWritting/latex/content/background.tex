...
\textit{ The app can be found at \url{https://play.google.com/store/apps/details?id=com.warrencollective.knittink} \small{(last accessed 08/11/2016))}}
\vspace*{0.5cm}
  ...
  \centering
    \begin{subfigure}[b]{0.4\textwidth}
      \centering
        ...
        \caption[Row counter \protect{\small at: \url{https://lh6.ggpht.com/-9DvA3pUKqPQwDwi8P_mZXOEhyKz9pE4Dks2QuEKxEGJePvXfY4hUkLO0i-zud38c5Y=h900-rw} (last accessed 04/04/2016)}]{Row counter}
    ...
    \end{subfigure}
  \caption[Screenshots of the app knit tink \protect{\small at: \url{https://play.google.com/store/apps/details?id=com.warrencollective.knittink} (last accessed 08/08/2016)}]{Screenshots of the app knit tink}
\end{figure}

\addcontentsline{toc}{subsubsection}{Knitting Counter by mkacki}
\subsubsection*{Knitting Counter by mkacki}

\textit{ The app can be found at \url{https://play.google.com/store/apps/details?id=org.kuklake.rowCounter} \small{(last accessed 08/11/2016))}}
\vspace*{0.5cm}
  ...
  \centering
    \begin{subfigure}[b]{0.33\textwidth}
      \centering
        ...
        \caption[Row counter \protect{\small at: \url{https://lh4.ggpht.com/M05RYCkE7md51ckjB9Bf_CQjz-L6fSS3aWFnQ8UAoURXjO4BuHZiWeHtImzAhhpvekE=h900-rw} (last accessed 04/04.2016)}]{Row counter}
    \end{subfigure}
    \begin{subfigure}[b]{0.33\textwidth}
      \centering
        \includegraphics[width=0.95\linewidth]{images/image06.png}
        \caption[Row counter setup \protect{\small at: \url{https://lh3.ggpht.com/AuzeRh7n_r4yLpk9puanH0pBDhcxj6AwC8h5qCaMN3TsRMRu7rML9awuPZTf49M_ejo=h900-rw} (last accessed 04/04/2016)}]{Row counter setup}
    \end{subfigure}
  \caption[Screenshots of the app Knitting Counter \protect{\small at: \url{https://play.google.com/store/apps/details?id=org.kuklake.rowCounter} (last accessed 08/11/2016))}]{Screenshots of the app Knitting Counter}
\end{figure}
...
\textit{ The app can be found at \url{https://play.google.com/store/apps/details?id=androiddeveloperjoe.knittingbuddy} \small{(last accessed 08/11/2016))}}
\vspace*{0.5cm}
  ...
  \centering
    \begin{subfigure}[b]{0.5\textwidth}
      \centering
        ...
        \caption[Row counter with pattern chart picture \protect{\small at: \url{https://lh3.ggpht.com/KJfgkhsUvqPCJSxqd7TfO9gVRgivtng8nfHgUENAHx401J-EqgPvTbCMW-dTrWVqzJE=h900-rw} (last accessed 04/04/2016)}]{Row counter with pattern chart picture}
    \end{subfigure}
    \begin{subfigure}[b]{0.33\textwidth}
      \centering
        \includegraphics[width=0.95\linewidth]{images/image05.png}
        \caption[Row counter with written pattern instructions \protect{\small at: \url{https://lh3.ggpht.com/EPs72ilPpGCF_fMckHsVb2LeYVx-p6eNjcqg69eOwlsS2h0neneeMEpH29CYH3rEM_c_=h900-rw} (last accessed 04/04/2016)}]{Row counter with written pattern instructions}
    \end{subfigure}
...
\textit{ The app can be found at \url{https://play.google.com/store/apps/details?id=com.knirirr.beecount} \small{(last accessed 08/11/2016))}}
\vspace*{0.5cm}
  ...
  \centering
    ...
    \begin{subfigure}[b]{0.4\textwidth}
      \centering
        ...
        \caption[Row counters setup \protect{\small from: \url{https://lh4.ggpht.com/ZD3ujRmMgBuxEaDjnCsc9fcN9k_kUQYwfEr_mQ23n7t-0sg-arQ0MMC-I52MI7ujc94=h900-rw} (last accessed 04/04/2016)}]{Row counters setup}
      \label{fig:row_counters_setup}
    \end{subfigure}
  \caption[Screenshots of the app BeeCount Knitting Counter \protect{\small at: \url{https://play.google.com/store/apps/details?id=com.knirirr.beecount} (last accessed 08/08/2016)}]{Screenshots of the app BeeCount Knitting Counter}
\end{figure}
...
\textit{The app can be found at \url{https://play.google.com/store/apps/details?id=knitting.chart.maker} \small{(last accessed 08/11/2016))}}
\vspace*{0.5cm}
...
\caption[Chart editor of Knitting Chart Maker \protect{\small at: \url{https://lh6.ggpht.com/MGKM0ukCDlMWWuboyxmZT-y8P3fTha4SI6l7u31eK3jFIkLsALlNEA_g6NffaoKRqyg=h900-rw} (last accessed 08/11/2016))}]{Chart editor of Knitting Chart Maker}
