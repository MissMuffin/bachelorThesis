...
\begin{figure}
  ...
  \begin{minipage}{1\textwidth}
    ...
    \caption[Editor screens for grid and row format with pattern name and save button in navigation bar \small (own image)] {Editor screens for grid and row format with pattern name and save button in navigation bar}
  ...
  \begin{minipage}{1\textwidth}
    ...
    \caption[Viewer screen for row format and selection screen for stored patterns \small (own image)]{Viewer screen for row format and selection screen for stored patterns}
